...
import { AlterarSenhaRoute, ConsultarTurmaRoute, FichaAlunoRoute, FichaTurmaRoute, FinanceiroRoute, NotasTurmaRoute } from './model/enums/constants';
...
const routes: Routes = [
  ...
  { path: FinanceiroRoute, component: FinanceiroComponent, canActivate: [AuthGuard] },
